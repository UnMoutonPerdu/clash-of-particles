/**
 * @file simulation-bh-pi.h
 * 
 * @brief Simple definition of the optimized simulation using binary heap calculating pi with the given number of digits and its functions.
 * 
 * @author Hugo MOUTON
 * 
 * @date 2022-02-24
 * 
 * This is a simple definition of how the optimized simulation is implemented to calculate pi. 
 * 
 ...
 * 
 */
void simulation_bh_pi(int argc, char** argv, double limit, double refresh, int n);
